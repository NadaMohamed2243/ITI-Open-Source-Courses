...
const progressBarOneQestion = document.querySelector("#progressQuestion");
...
//---time for each question (6 sec)
function questionTime() {
    let timeLeft = 6;
    progressBarOneQestion.style.width = "100%";
    clearInterval(interval);

    interval = setInterval(() => {
        timeLeft--;
        let width = (timeLeft / 6) * 100;
        progressBarOneQestion.style.width = `${width}%`;
