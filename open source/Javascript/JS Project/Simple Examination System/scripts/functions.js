...
import { questionTime, startTimer } from './external.js'
...
export function startExamSetting(currentQustionIndex, questionTitle, questionImage, questionAnswers, progressBar, nextBtn, timerId) {
    randomize(questions)
...
export function showQuestion(currentQustionIndex, questionTitle, questionImage, questionAnswers, progressBar, nextBtn, timerId) {
    startTimer();
    questionTime();
