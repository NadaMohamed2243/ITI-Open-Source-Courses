...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (count($errors) > 0) {
            ...
            $stmt= $db->update_data("users","first_name = '$fname', last_name = '$lname', address = '$address', country = '$country', gender = '$gender', username = '$username', password = '$password', image_name = '$imageName'","id = '$userId'");
            ...
            foreach ($selectedSkills as $skill) {
                ...
                $stmt = $db->insert_data("user_skills", "user_id, skill", "'$userId','$skill'");
